...
const Hero = () => {
    ...
    return (
        <div className='flex-grow  flex-shrink-0 bg-secondary-600 relative overflow-hidden h-full'>
            <div className='w-full lg:aspect-video lg:absolute top-0 left-0 right-0 bottom-0 h-full lg:object-contain lg:-translate-y-1/4'>
            ...
            <div>
                <div className='absolute top-0 left-0 right-0 bottom-0 z-[1300] bg-black/25'>

                </div>
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 text-white -translate-y-1/2 z-[1350] w-full text-center'>
                    <h1 className='font-extrabold text-3xl md:text-4xl lg:text-7xl'>Your body deserves better</h1>
